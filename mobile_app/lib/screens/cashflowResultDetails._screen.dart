                            ...
                            child: Container(
                              ...
                              child: Table(
                                children: [
                                  ...
                                  TableRow(children: [
                                    Text("Net Operating"),
                                    Text(CF_item.monthlyNetOpIncomeReal
                                        .toString()),
                                    Text(CF_item.monthlyNetOpIncomeHypo
                                        .toString()),
                                  ]),
                                  TableRow(children: [
                                    Text("Expenses"),
                                  ...
                                  TableRow(children: [
                                    Text("Net Operating"),
                                    Text(CF_item.monthlyNetOpCostsReal
                                        .toString()),
                                    Text(CF_item.monthlyNetOpCostsHypo
                                        .toString()),
                                  ]),
                                  TableRow(children: [
                                    Text("Total Monthly (incl. mortgage)"),
                                    Text(
                                        CF_item.monthlyExpensesReal.toString()),
                                    Text(
                                        CF_item.monthlyExpensesHypo.toString()),
                                  ]),
                                  TableRow(children: [
                                    Text("Cashflow Stats"),
                                    Text(""),
                                  ...
                                  TableRow(children: [
                                    Text("Cashflow"),
                                    Text(
                                        CF_item.cashflowMonthlyReal.toString()),
                                    Text(
                                        CF_item.cashflowMonthlyHypo.toString()),
                                  ]),
                                  TableRow(children: [
                                    Text("coc ROI"),
